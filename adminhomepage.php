...
<body>
    <header>
        ...
        <div class="nav">
            <a href="adminprofilepage.php" class="profile-button">
    ...
    <main>
        ...
        <section class="hero">
            ...
            <a href="addcar.php" class="book-button">Add New Car</a>
        ...
        <section class="car-list">
            ...
            <div class="car-info">
                ...
                <a href="deletecar.php?id=<?= $car['id']; ?>" class="delete-button">Delete</a>
